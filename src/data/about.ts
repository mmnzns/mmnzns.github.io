...
export const BELIEFS = [
  {
    ...
    body: 'I grew up on a farm, where problems rarely arrived with instructions and you learned to work with what you had. If something broke, the first job was understanding why. That taught me to observe carefully, ask questions, and make sure I’m solving the right problem before reaching for a solution.',
  },
  {
    claim: 'Numbers show you where to look. People help you understand why.',
    body: 'A dashboard can show where customers are hesitating or leaving, but it can’t fully explain what they experienced in that moment. The useful answer usually comes from combining the data with curiosity, customer context, and the knowledge held by people closest to the work.',
  },
  {
    claim: 'If a system only works when I’m in the room, it isn’t finished.',
    body: 'I document what I build, involve the people who will operate it, and make handoff part of the work—not an afterthought. I’ve trained a successor in every major role I’ve left. The real test is whether the system keeps helping people after I’m gone.',
  },
  {
    claim: 'Be honest about the tradeoffs.',
    body: 'Every worthwhile decision gives something up somewhere else: time, cost, flexibility, speed, or simplicity. I’d rather make those tradeoffs visible early so everyone can make the decision with clear eyes.',
  },
  {
...
export const ROLES = [
  ...
  },
  {
    ...
    what: 'Built a 20+ person collective that helped 26 small businesses rebuild their digital presence after the pandemic',
    years: '2022 — 2025',
  },
  {
    org: 'DTC Newsletter · Pilothouse',
    title: 'Email & Website Operations Manager (MarTech)',
    what: 'Lifecycle, web, martech, deliverability, and AI workflows across two companies and client accounts',
    years: '2021 — 2024',
  },
  {
    org: 'Sportserve',
    title: 'Senior Marketing Projects and Operations Manager',
    what: 'Global lifecycle and payments operations; built and led the Payments Operations division',
    years: '2014 — 2021',
  },
  {
    org: 'Rappler',
